...
Recognizing the need for reproducible and auditable experiments in safety-critical contexts, the thesis also develops \texttt{deckard}, a declarative pipeline framework for distributed and robust machine learning experimentation (Paper VI).
