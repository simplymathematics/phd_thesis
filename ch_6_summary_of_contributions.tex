...
\section{Paper I}
Meyers, Charles, Tommy L\"{o}fstedt, and Erik Elmroth. "Safety-critical computer vision: an empirical survey of adversarial evasion attacks and defenses on computer vision systems." {\em Artificial Intelligence Review}, Vol. 53, pp. 217--251, Springer, (2023). [Impact Factor 10.7.]
...
\section{Paper V}
Meyers, Charles,  Aaron MacSween Tommy L\"{o}fstedt, and Erik Elmroth. “Privacy-preserving anomaly detection." This will be submitted to ... in October.
...
Finally, to account for traditional metrics and various robustness criteria, the software can be used with a variety of multi-objective optimisation algorithms
...
This thesis contributes to the nascent field of trustworthy machine learning by introducing empirical techniques for quantifying model robustness, proposes a privacy-preserving classification model, and provides a platform for reproducible experimentation. 
...
By shifting from training-time interventions like poisoning attacks to run-time interventions like evasion, extraction, or inference attacks, this approach could potentially detect and mitigate sampling noise, sensor failure, or any other scenario that can be simulated at run-time. 
Ultimately, by formalising these techniques, the hope is to derive guarantees for adversarial robustness that provide a useful estimate of the real-world failure rate while considering fairness, equity, and environmental impact. 
While this thesis falls short of a solving the problem of adversaries in ML systems, it is a step towards the deployment of ML systems that are not just accurate, but also responsible, private, reliable, secure, safe, and, above all, trustworthy.